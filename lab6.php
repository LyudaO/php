...
<body>
    <div class="container">
        <h1>Лабораторна робота 6: Робота з нормалізованою базою даних</h1>
        ...
        <table>
            ...
            function getUniqueCountries($filename) {
            ...
            function saveCountries($filename, $countries) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['country'])) {
                ...
                $countries = getUniqueCountries($filename);
                if (!in_array($newEntry, $countries)) {
                    $countries[] = $newEntry;
                    saveCountries($filename, $countries);
                }
            }
